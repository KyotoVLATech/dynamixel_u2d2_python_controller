...
async def main() -> None:
    ...
    try:
        ...
        async with controller:
            ...
            # モーター4は位置0.25rad、電流制限372units(約1000mA)
            goals2 = {4: (0.25, 372)}

            await controller.set_position_and_current_goals_rad_async(goals2)
            logger.info(f"BulkWrite: New goals(rad) set: {goals2}")
